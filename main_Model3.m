...
% % save results
% save('fit_Model3.mat', 'LH', 'initguessmatrix', 'params','fit_res', 'parmatrix', 'best_fit', "grad_all", "lambda_all","hessian_all")
...
xlabel('time [days]')
% saveas(gcf,['Model3','.png'])
% saveas(gcf,['Model3','.svg'])
